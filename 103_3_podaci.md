...
[listing:nepoznati_podatak](#listing-nepoznati_podatak), vrijednost varijable
...
```python
Još operacija s brojevimalisting:brojevi_operacije2
...
funkcije 0.8509035245341184

>>> math.pi 3.141592653589793 \# konstanta
```
...
```python
Operatori \"=\" i \"==\" u programiranjulisting:bool3

>>> x = 1 \# pridruživanje: \"neka x bude 1\", ovo nije izraz pa nema
rezultata
...
```python
Usporedba tekstalisting:bool4

>>> a = 'nešto'

>>> b = 'nešto drugo'

>>> a == b \# većina osnovnih vrsti podataka dopušta provjeru
jednakosti False
...
>>> b.startswith(a) \# posebne provjere se često provode posebnim
metodama za vrste vrijednosti True
...
```python
Koje vrijednosti \"postoje\"?listing:bool5

>>> bool(42) True

>>> bool(0) False

>>> bool(None) \# vrijednost None je opisana u nastavku ovog
poglavlja False
...
>>> bool(\[\]) \# prazan popis, više o popisima kasnije False \# ali
zapamtimo da se prazne zbirke procjenjuju kao False
```
...
```python
Booleovi operatorilisting:bool6
