...
[podaci_vrste](#podaci_vrste) i [podaci_tekst](#podaci_tekst) riječ o osnovnim vrstama podataka i radnjama s
...
[kontrola_toka](#kontrola_toka), definicija funkcija i klasa u dijelu
[abstrakcija](#abstrakcija), a korutine nisu obrađene u ovoj knjizi.
...
U retku 11 primjera
[listing:statements_expression](#listing:statements_expression) vidimo izjavu koja se sastoji
...
[1][Tablica operatora aritmetika](#tablica-operatori-aritmetika).
